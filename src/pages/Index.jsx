      ...
      <VStack spacing={4} align="stretch">
        {tweets.map((tweet) => (
          <Box key={tweet.id} borderWidth={1} borderRadius="md" p={4}>
            <HStack mb={2}>
              <Avatar src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MDcxMzJ8MHwxfHNlYXJjaHwyfHx1c2VyJTIwYXZhdGFyfGVufDB8fHx8MTcxMDAyMTA1OXww&ixlib=rb-4.0.3&q=80&w=1080" size="sm" />
